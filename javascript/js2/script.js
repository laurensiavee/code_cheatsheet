...
// selector, single & multi element

// single
console.log(document.getElementById('my-form'));
console.log(document.querySelector('h1')); // kek jquery, buat grab selain pke id, single, sleect 1 = top

// multi
console.log(document.querySelectorAll('.item')); // prefer ini dibanding multi yg lain, query bisa select pke id, class, tag terserah, list nodelist
console.log(document.getElementsByClassName('item')); // list html collector, hrs cnvert ke arr
...
btn.addEventListener('click', (e) => {
    e.preventDefault(); // prevent ilang console log nya krn klo form bawaan nya button submit bgtu
    console.log('click');
    console.log(e); // e = event object
    console.log(e.target.className); // e = event object 
    document.querySelector('#my-form').style.background = '#ccc'
    document.querySelector('body').classList.add('bg-dark'); // add class html, add css
    document.querySelector('.items').lastElementChild.innerHTML = '<h1>hellor</h1>'
})
